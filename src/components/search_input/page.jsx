...
export const SearchComponent = (props) => {
  ...
  return (
    <button onClick={() => props.triggerSearch(values)} className="flex justify-end items-center w-72 hover:-translate-y-1 duration-300 fixed top-5">
      <input onChange={handleInput} className="bg-teal-300 text-black p-2 rounded-lg min-w-full outline-none font-semibold font-mono shadow-slate-800 hover:outline-slate-950 focus:outline-slate-500" />
